    ...
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
        ...
        <div className='min-w-60'>
          ...
          <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '':'hidden'} sm:block`}>
            ...
            <div className='flex flex-col gap-2 text0sn font-light text-gray-700'>
        ...
        <div className='flex-1'> 
          <div className='flex justify-between text-base sm:text-2x1 mb-4'>
              ...
              <select onChange={(e)=>setSortType(e.target.value)} className='border-2 border-gray-300 text-sm px-2'>
                ...
                <option value="low-high">Organizar Por: Preço baixo - alto</option>
                <option value="high-low">Organizar Por: Preço alto - baixo</option>
              </select>
          </div>
       {/*Mapear Produtos*/}
