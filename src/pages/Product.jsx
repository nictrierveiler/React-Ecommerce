...
const Product = () => {
  ...
  const {products, moeda, addToCart} = useContext(ShopContext);
    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex-1'>
          ...
          <div className='flex items-center gap-1 mt-2'>
           ...
           <button onClick={()=>addToCart(productData._id,size)} className='bg-black text-white px-8 py-3 text-sm active:bg-gray-700'>ADICIONE AO CARRINHO</button>
